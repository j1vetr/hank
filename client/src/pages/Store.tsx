      ...
      <footer className="bg-zinc-950 border-t border-white/10 py-16 px-6">
        <div className="max-w-[1400px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            <div>
              <h4 className="font-display text-2xl tracking-wider mb-6">HANK</h4>
              <p className="text-sm text-white/50 leading-relaxed">
                Premium spor giyim markası. Güç, performans ve stil bir arada.
              </p>
            </div>
            ...
            <div>
              <h4 className="font-display text-lg tracking-wider mb-6">YARDIM</h4>
              <ul className="space-y-4 text-sm text-white/50">
            ...
            <div>
              <h4 className="font-display text-lg tracking-wider mb-6">İLETİŞİM</h4>
              <ul className="space-y-4 text-sm text-white/50">
                <li>info@hank.com.tr</li>
          ...
          <div className="border-t border-white/10 mt-12 pt-8 text-center text-sm text-white/30">
            <p>© 2024 HANK. Tüm hakları saklıdır.</p>
          </div>
        </div>
      </footer>
    </div>
